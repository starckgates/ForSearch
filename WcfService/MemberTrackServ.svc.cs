...
namespace WcfService
{
    ...
    public class MemberTrackServ : IMemberTrackServ
    {
        private IMemberTrackDal _dal = new MemberTrackDal();

        public string GetList(MemberTrackDal.SearchCondition sc, out int em)
        {
